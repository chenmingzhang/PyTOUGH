...
aqui_con=t2listing.toughreact_tecplot('tec_conc.out',inp.grid.blocklist)
...
aqui_min=t2listing.toughreact_tecplot('tec_min.out',inp.grid.blocklist)
aqui_gas=t2listing.toughreact_tecplot('tec_gas.out',inp.grid.blocklist)
