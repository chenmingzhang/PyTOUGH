...
aqui_con=t2listing.toughreact_tecplot('aqui_con.dat',inp.grid.blocklist)
...
aqui_min=t2listing.toughreact_tecplot('aqui_min.dat',inp.grid.blocklist)
aqui_gas=t2listing.toughreact_tecplot('aqui_gas.dat',inp.grid.blocklist)
