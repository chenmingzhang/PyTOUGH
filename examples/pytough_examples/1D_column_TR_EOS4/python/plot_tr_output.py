...
i = opt_idx[0]; im0 = ax[0].plot(ele_depth_m, aqu.tx_mtx['pH'][i] , label="%.1e" % aqu.times[i]+'yrs')
i = opt_idx[1]; im0 = ax[0].plot(ele_depth_m, aqu.tx_mtx['pH'][i] , label="%.1e" % aqu.times[i]+'yrs')
i = opt_idx[2]; im0 = ax[0].plot(ele_depth_m, aqu.tx_mtx['pH'][i] , label="%.1e" % aqu.times[i]+'yrs')
i = opt_idx[3]; im0 = ax[0].plot(ele_depth_m, aqu.tx_mtx['pH'][i] , label="%.1e" % aqu.times[i]+'yrs')
i = opt_idx[4]; im0 = ax[0].plot(ele_depth_m, aqu.tx_mtx['pH'][i] , label="%.1e" % aqu.times[i]+'yrs')
i = opt_idx[5]; im0 = ax[0].plot(ele_depth_m, aqu.tx_mtx['pH'][i] , label="%.1e" % aqu.times[i]+'yrs')



im1 = ax[1].plot(aqu.tx_mtx['X'][0] , aqu.tx_mtx['t_h2o'][0])
im1 = ax[1].plot(aqu.tx_mtx['X'][1] , aqu.tx_mtx['t_h2o'][1])
im1 = ax[1].plot(aqu.tx_mtx['X'][2] , aqu.tx_mtx['t_h2o'][2])
im1 = ax[1].plot(aqu.tx_mtx['X'][3] , aqu.tx_mtx['t_h2o'][3])
im1 = ax[1].plot(aqu.tx_mtx['X'][4] , aqu.tx_mtx['t_h2o'][4])
im1 = ax[1].plot(aqu.tx_mtx['X'][5] , aqu.tx_mtx['t_h2o'][5])



im2 = ax[2].plot(aqu.tx_mtx['X'][0] , aqu.tx_mtx['t_h+'][0])
im2 = ax[2].plot(aqu.tx_mtx['X'][1] , aqu.tx_mtx['t_h+'][1])
im2 = ax[2].plot(aqu.tx_mtx['X'][2] , aqu.tx_mtx['t_h+'][2])
im2 = ax[2].plot(aqu.tx_mtx['X'][3] , aqu.tx_mtx['t_h+'][3])
im2 = ax[2].plot(aqu.tx_mtx['X'][4] , aqu.tx_mtx['t_h+'][4])
im2 = ax[2].plot(aqu.tx_mtx['X'][5] , aqu.tx_mtx['t_h+'][5])
...
im8 = ax[8].plot(aqu.tx_mtx['X'][2] , aqu.tx_mtx['t_so4-2'][2])
im8 = ax[8].plot(aqu.tx_mtx['X'][3] , aqu.tx_mtx['t_so4-2'][3])
im8 = ax[8].plot(aqu.tx_mtx['X'][4] , aqu.tx_mtx['t_so4-2'][4])
im8 = ax[8].plot(aqu.tx_mtx['X'][5] , aqu.tx_mtx['t_so4-2'][5])
...
im15 = ax[15].plot(sod.tx_mtx['X'][0],sod.tx_mtx['calcite'][0])
im15 = ax[15].plot(sod.tx_mtx['X'][1],sod.tx_mtx['calcite'][1])
im15 = ax[15].plot(sod.tx_mtx['X'][2],sod.tx_mtx['calcite'][2])
im15 = ax[15].plot(sod.tx_mtx['X'][3],sod.tx_mtx['calcite'][3])
im15 = ax[15].plot(sod.tx_mtx['X'][4],sod.tx_mtx['calcite'][4])
im15 = ax[15].plot(sod.tx_mtx['X'][5],sod.tx_mtx['calcite'][5])
...
ax[10].set_title('aqu_\n X_na+'  ,fontweight='bold')
ax[11].set_title('aqu_\n X_k+'   ,fontweight='bold')
ax[12].set_title('aqu_\n X_ca+2' ,fontweight='bold')
ax[13].set_title('aqu_\n X_mg+2' ,fontweight='bold')
ax[14].set_title('aqu_\n X_h+'   ,fontweight='bold')
ax[15].set_title('sod_\n calcite',fontweight='bold')
