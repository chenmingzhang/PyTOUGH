...
fig.suptitle(   cwd     , fontsize=8,fontweight="bold")
print(tlt)
no_row=7
no_col=5
...
def plot_aqua_profile(ax_idx=ax[25], aqu_name='t_sio2(aq)',aqu_input=aqu,ele_depth_m=ele_depth_m,opt_idx=opt_idx ):
    if any(aqu_name == s for s in aqu.element.column_name):
...
def plot_gas_profile(ax_idx=ax[25], gas_name='t_sio2(aq)',gas_input=gas,ele_depth_m=ele_depth_m,opt_idx=opt_idx ):
    if any(gas_name == s for s in gas.element.column_name):
        i = opt_idx[0] ; im25 = ax_idx.plot( gas_input.tx_mtx[gas_name][i] , ele_depth_m )
        i = opt_idx[1] ; im25 = ax_idx.plot( gas_input.tx_mtx[gas_name][i] , ele_depth_m )
        i = opt_idx[2] ; im25 = ax_idx.plot( gas_input.tx_mtx[gas_name][i] , ele_depth_m )
        i = opt_idx[3] ; im25 = ax_idx.plot( gas_input.tx_mtx[gas_name][i] , ele_depth_m )
        i = opt_idx[4] ; im25 = ax_idx.plot( gas_input.tx_mtx[gas_name][i] , ele_depth_m )
        i = opt_idx[5] ; im25 = ax_idx.plot( gas_input.tx_mtx[gas_name][i] , ele_depth_m )
        ax_idx.set_xlabel('gas_'+ gas_name ,fontweight='bold',fontsize=8)
        ax_idx.invert_yaxis()
        ax_idx.set_ylabel('Depth (m)' , fontweight='bold',fontsize=8)
...
if any('o2(g)' == s for s in gas.element.column_name):
...
i = opt_idx[0] ; im16 = ax[18].plot(opt.tx_con_mtx['FLO(GAS)'][i]*sPday/gas_density_kgPm3/dx[0]/dy[0]/mPmm, con_depth_m)
i = opt_idx[1] ; im16 = ax[18].plot(opt.tx_con_mtx['FLO(GAS)'][i]*sPday/gas_density_kgPm3/dx[0]/dy[0]/mPmm, con_depth_m)
i = opt_idx[2] ; im16 = ax[18].plot(opt.tx_con_mtx['FLO(GAS)'][i]*sPday/gas_density_kgPm3/dx[0]/dy[0]/mPmm, con_depth_m)
i = opt_idx[3] ; im16 = ax[18].plot(opt.tx_con_mtx['FLO(GAS)'][i]*sPday/gas_density_kgPm3/dx[0]/dy[0]/mPmm, con_depth_m)
i = opt_idx[4] ; im16 = ax[18].plot(opt.tx_con_mtx['FLO(GAS)'][i]*sPday/gas_density_kgPm3/dx[0]/dy[0]/mPmm, con_depth_m)
i = opt_idx[5] ; im16 = ax[18].plot(opt.tx_con_mtx['FLO(GAS)'][i]*sPday/gas_density_kgPm3/dx[0]/dy[0]/mPmm, con_depth_m)
...
plot_gas_profile(ax_idx=ax[34], gas_name='o2(g)',gas_input=gas,ele_depth_m=ele_depth_m,opt_idx=opt_idx )
...
# ca(hco3)2 unit mg/l vs mg/l. the original unit is mol/l
...
# o2(g) VS o2(aq)
if (any("o2(g)" in s for s in gas.element.column_name) and any("t_o2(aq)" in s for s in aqu.element.column_name)  )  :
    i = opt_idx[1] ; im27 = ax[31].plot( gas.tx_mtx['o2(g)'][i][::5]*mmass_o2_kgPmol*mgPkg , aqu.tx_mtx['t_o2(aq)'][i][::5]*mmass_o2_kgPmol*mgPkg , 'x' , markersize=6, color = 'brown')
    i = opt_idx[2] ; im27 = ax[31].plot( gas.tx_mtx['o2(g)'][i][::5]*mmass_o2_kgPmol*mgPkg , aqu.tx_mtx['t_o2(aq)'][i][::5]*mmass_o2_kgPmol*mgPkg , 'v' , markersize=6, color = 'brown')
    i = opt_idx[3] ; im27 = ax[31].plot( gas.tx_mtx['o2(g)'][i][::5]*mmass_o2_kgPmol*mgPkg , aqu.tx_mtx['t_o2(aq)'][i][::5]*mmass_o2_kgPmol*mgPkg , '+' , markersize=6, color = 'brown')
    i = opt_idx[4] ; im27 = ax[31].plot( gas.tx_mtx['o2(g)'][i][::5]*mmass_o2_kgPmol*mgPkg , aqu.tx_mtx['t_o2(aq)'][i][::5]*mmass_o2_kgPmol*mgPkg , 'o' , markersize=6, color = 'brown')
    i = opt_idx[5] ; im27 = ax[31].plot( gas.tx_mtx['o2(g)'][i][::5]*mmass_o2_kgPmol*mgPkg , aqu.tx_mtx['t_o2(aq)'][i][::5]*mmass_o2_kgPmol*mgPkg , '*' , markersize=6, color = 'brown')
...
ax[31].set_ylabel('t_o2(aq) mg/L' , fontweight='bold')
...
ax[18].set_xlabel('opt_FLO(GAS)(mm/day)',fontweight='bold')
...
ax[31].set_xlabel('o2(g) '        ,fontweight='bold')

for a in ax:
    a.grid()

#output_name = 'figure/'+'chemcal'+'.png'
output_name = 'figure/'+'chemcal_'+directory_name+'.png'
